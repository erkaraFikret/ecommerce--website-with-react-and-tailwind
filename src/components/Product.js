  ...
  return (
    <div>
      <div className='border border-[#e4e4e4] h-[300px] relative overflow-hidden group transition'>
        <div className='w-full h-full flex jus items-center'>
        ...
        <div className='absolute top-6 -right-11 group-hover:right-5  sm:group-hover:right-1 p-2 flex flex-col items-center justify-center gap-y-2 
